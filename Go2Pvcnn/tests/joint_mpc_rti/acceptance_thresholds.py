...
THRESHOLDS: dict[str, tuple[str, float]] = {
    ...
    "root_zero_drift_one_gait_m": ("le", 1.0e-5),
    "root_zero_drift_10_gaits_m": ("le", 1.0e-5),
    "root_zero_drift_1000_refresh_m": ("le", 1.0e-5),
    "root_step_jump_m": ("le", 0.05),
    "root_roll_deviation_rad": ("le", math.radians(6.0)),
    "root_pitch_deviation_rad": ("le", math.radians(6.0)),
    "alpha0_selected_ratio": ("le", 0.05),
    "alpha0_selected_max_run": ("le", 2.0),
    "line_search_no_feasible_ratio": ("le", 0.0),
    "publish_ratio": ("ge", 1.0),
    "stop_ratio": ("le", 0.0),
    ...
    "map_age_frames_max": ("le", 0.0),
    "map_state_frame_mismatch_count": ("le", 0.0),
    "world_query_transform_error": ("le", 1.0e-6),
    "cold_start_count": ("ge", 1.0),
    "unexpected_cold_restart_count": ("le", 0.0),
    "warm_cache_invariant_fault_count": ("le", 0.0),
    "latched_target_drift_m": ("le", 0.0),
    "kkt_primal_residual": ("le", 1.0e-4),
    "kkt_dual_residual": ("le", 1.0e-4),
    "nominal_safe_after_retarget": ("ge", 1.0),
    "nominal_min_clearance_after_retarget": ("ge", 0.0),
    ...
    "cross_direction_margin_mps": ("ge", 0.0),
