...
def test_decode_parametric_full_cycle_replan_does_not_accumulate_root_relative_foot_drift() -> None:
    ...
    first = decode_parametric_trajectory(state0, terrain, command, variables0, horizon=25)
    ...
    second = decode_parametric_trajectory(state1, terrain, command, variables1, horizon=25)
