...
| T302o | active | New evaluation route will load policy checkpoints while enabling MPC reference/cache, report tracking metrics, and measure flat small-obstacle collision rate by collided envs per round. | Task 4 tracking metrics are real-smoke verified; implement Task 5 small_collision runtime metrics. |
...
| T302o.1 | T302o | active | P0 | Task 4 tracking runtime metrics are implemented and real-smoke verified; Task 5 small_collision runtime metrics remain. | [T302o plan](todo/T302o-mpc-policy-eval-plan.md#task-5-small-collision-mode-runtime-metrics) |
