...
- Current focus: T116 `K=5` mode-first small-obstacle crossing has now closed the `T116i` follow-up for nonzero speed candidate tables and hard-reason diagnostics.
  ...
  - T302 is a new MPC design branch related to T300e for body/leg height-field collision safety, semantic stance/touchdown obstacle rejection, low-small crossing, high-small/large avoidance, yaw-only obstacle risk, and real `env_isaacsim` headless acceptance; the detailed TDD implementation plan is now written in the T302 branch page.
- Read next:
...
| T302 | Body/leg height-field collision safety now has a detailed TDD implementation plan embedded in the T302 branch page, including backend losses, GPU guardrails, COBBLESTONE headless tests, and semantic low/high obstacle acceptance. | Execute the plan task-by-task, preferably subagent-driven with main-agent review between slices. |
...
| T302 | verify | MPC body/leg collision and obstacle behavior design/planning | [T302](todo/T302-mpc-body-leg-height-field-collision-safety.md) | design recorded and detailed TDD implementation plan written for kinematics, collision losses, risk scaling, GPU guardrails, COBBLESTONE, semantic low-small/high-small/large acceptance, and T300e regression preservation | feature `pending`; verified `subagent design coverage review + plan self-check` |
...
| T302b | T302/T300e | verify | P0 | Detailed TDD implementation plan is written; implementation has not started. | [T302 branch](todo/T302-mpc-body-leg-height-field-collision-safety.md) + [plan log](log/2026-05-16-2231-t302-implementation-plan.md) |
